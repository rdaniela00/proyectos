...
preCarga(300);
    ...
    $("#icoMostrar").removeClass("fas fa-eye fa-lg");
      $("#icoMostrar").addClass("fas fa-eye-slash fa-lg");
    }
    else
    {
    ...
    $("#icoMostrar").removeClass("fas fa-eye-slash fa-lg");
      $("#icoMostrar").addClass("fas fa-eye fa-lg");
    }
