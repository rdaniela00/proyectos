    ...
    public partial class frmModulos : Form
    {
        ...
        void modificarPersona()
        {
            ...
            try
            {
                ...
                qry = "SELECT modulo from modulos where modulo = '" + this.txtmodulo.Text + "' and id_modulo!= " + this.dgModulos.CurrentRow.Cells["id_modulo"].Value.ToString() + "";
        ...
        void grid()
        {
            ...
            try
            {
                ...
                {
                    qry = "select modulos.id_modulo, modulos.mpersonas, modulos.musuarios, modulos.trabajadores, modulos.modulo, modulos.activo, modulos.fecha_registro, modulos.hora_registro, modulos.id_usuario from modulos where modulos.activo=1";
                }
                else
                {
                    //guardamos la consulta en qry
                    qry = "select modulos.id_modulo, modulos.mpersonas, modulos.musuarios, modulos.trabajadores, modulos.modulo, modulos.activo, modulos.fecha_registro, modulos.hora_registro, modulos.id_usuario from modulos where modulos.activo=0";
                }
        ...
        void desactivarPersona()
        {
            ...
            try
            {
                ...
                qry = "UPDATE modulos SET activo=0 where id_modulo=" + dgModulos.CurrentRow.Cells["id_modulo"].Value.ToString() + "";
        ...
        void activarPersona()
        {
            ...
            try
            {
                ...
                qry = "UPDATE modulos SET activo=1 where id_modulo=" + dgModulos.CurrentRow.Cells["id_modulo"].Value.ToString() + "";
        ...
        private void txtmodulo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("Debes de escribir el modulo");
                    this.txtmodulo.Focus();
                    return;
                }
            }
        ...
        private void modificarmenu_Click(object sender, EventArgs e)
        {
            ...
            this.txtmodulo.Text = dgModulos.CurrentRow.Cells["modulo"].Value.ToString();
            this.txtactivo.Text = dgModulos.CurrentRow.Cells["activo"].Value.ToString();
            this.lblfecharegistro.Text = dgModulos.CurrentRow.Cells["fecha_registro"].Value.ToString();
            this.lblhoraregistro.Text = dgModulos.CurrentRow.Cells["hora_registro"].Value.ToString();
            this.txtidusuario.Text = dgModulos.CurrentRow.Cells["id_usuario"].Value.ToString();
            if (dgModulos.CurrentRow.Cells["mpersonas"].Value.ToString() == "1")
            {
            ...
            if (dgModulos.CurrentRow.Cells["musuarios"].Value.ToString() == "1")
            {
            ...
            if (dgModulos.CurrentRow.Cells["mtrabajadores"].Value.ToString() == "1")
            {
